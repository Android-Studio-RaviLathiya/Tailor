...
public class EditPasnalDetail extends AppCompatActivity {
        ...
        go.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fname.equals("")) {
                    ...
                    Toast.makeText(EditPasnalDetail.this, "Update", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(EditPasnalDetail.this, BusinessProfile.class));
                    finish();
