...
public class EditOtherBranchDetail extends AppCompatActivity {
        ...
        go.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (shopname.equals("")) {
                    ...
                    startActivity(new Intent(EditOtherBranchDetail.this, BusinessProfile.class));
                    finish();
                    Toast.makeText(EditOtherBranchDetail.this, "Update", Toast.LENGTH_SHORT).show();
